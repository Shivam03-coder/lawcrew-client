      ...
      <Card className="bg-sky-50 border-none shadow-none">
        <CardHeader>
          <div className="flex items-center space-x-2">
            ...
            <CardTitle className="font-lexend font-normal text-xl">Important Notices & Compliance Updates</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Your GST payment for Q1 2024 is due in 15 days. Please ensure
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Please update your business registration documents before the
                next filing.
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Recent changes in tax regulations may affect your next filing.
                Review the updates in the compliance section.
              </p>
            </div>
          </div>
        </CardContent>
