...
const PlanCards = () => {
  return (
    <section className="my-5 grid w-full grid-cols-3 gap-6">
      ...
      <Card className="max-h-auto inline-flex w-full max-w-[24rem] flex-col">
        ...
        <div className="inline-flex h-[120px] flex-col items-start justify-center gap-6 bg-secondary p-8">
