          ...
          <div className="relative mx-auto mt-10 w-full max-w-xl">
                ...
                >
                  ...
                  <div className="mt-2 flex w-full flex-col items-start justify-between text-sm text-neutral-600 dark:text-neutral-400 md:flex-row md:items-center">
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-md bg-secondary px-1 py-0.5 dark:bg-neutral-800"
                    >
                      {file.type}
                    </motion.p>
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative z-40 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md bg-primary group-hover/file:shadow-2xl dark:bg-neutral-900",
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute inset-0 z-30 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md border-2 border-dashed border-primary bg-primary opacity-0"
              ></motion.div>
            )}
          </div>
        </div>
